#Rodas Gebreyohannes
import unittest
from test matchmaker import rate, match  # Import the functions to be tested
...
class TestMatchmaker(unittest.TestCase):
    ...
    def test_match_politics(self):
        ...
        self.assertAlmostEqual(match(person1, person2), 0.2, places=1)  # Test with same politics

        person1 = (7, 10, 8, 9, 10, "buddhism", 6, 9)
        person2 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        self.assertAlmostEqual(match(person1, person2), 0.1, places=1)  # Test with different politics
    ...
    def test_match_religion(self):
        ...
        person1 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        person2 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        self.assertAlmostEqual(match(person1, person2), 0.2, places=1)  # Test with same religion

        person1 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        person2 = (7, 10, 8, 9, 10, "judaism", 6, 8)
        self.assertAlmostEqual(match(person1, person2), 0.0, places=1)  # Test with different religion
    ...
    def test_match_ratings(self):
        ...
        person1 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        person2 = (7, 10, 8, 9, 10, "buddhism", 6, 8)
        self.assertAlmostEqual(match(person1, person2), 0.2, places=1)  # Test with same ratings

        person1 = (0, 0, 0, 0, 0, "buddhism", 0, 0)
        person2 = (10, 10, 10, 10, 10, "buddhism", 10, 10)
        self.assertAlmostEqual(match(person1, person2), 0.0, places=1)  # Test with different ratings
